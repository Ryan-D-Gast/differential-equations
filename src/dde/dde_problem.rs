    ...
    H: Fn(T) -> V + Clone, // Require Clone for H if DDEProblem needs Clone
{
    ...
    /// Returns a DDEProblem NumericalMethod with the provided solout function for outputting points.
    ///
    /// # Returns
    /// * DDEProblem NumericalMethod with the provided solout function ready for .solve() method.
    ///
    ...
    ///
    /// # Returns
    /// * DDEProblem NumericalMethod with Even Solout function ready for .solve() method.
    ///
    ...
    ///
    /// # Returns
    /// * DDEProblem NumericalMethod with Dense Output function ready for .solve() method.
    ///
    ...
    ///
    /// # Returns
    /// * DDEProblem NumericalMethod with CrossingSolout function ready for .solve() method.
    ///
    pub fn crossing(
        &self,
        component_idx: usize,
    ...
    ///
    /// # Returns
    /// * DDEProblem NumericalMethod with HyperplaneCrossingSolout function ready for .solve() method.
    ///
    ...
    O: Solout<T, V, D>,
{
    ...
    ///
    /// # Arguments
    /// * `solver` - NumericalMethod to use for solving the DDEProblem
    ///
    /// # Returns
    /// * `Result<Solution<T, V, D>, Error<T, V>>` - `Ok(Solution)` if successful or interrupted by events, `Err(Error)` if errors or issues are encountered.
    ///
